        ...
        {customization.header_config.show_address && (
          <p className="text-xs">
            ...
            {customization.company_details?.address ||
              "Varur, Hubballi-580 030"}
          </p>
        )}
        <p className="text-xs">
          Email:{" "}
          {customization.company_details?.email || "info@vrllogistics.com"} |
...
const LiveMinimalPreview = ({ customization, booking }) => {
  ...
  const parseCargoAndMaterials = (cargoUnits, materials) => {
    const cargoArray = cargoUnits
      ? cargoUnits.split(",").map((c) => c.trim())
      : [];
    ...
    >
          ...
          {customization.header_config.logo_position !== "left" && (
            <div className="text-left">
              ...
              <div className="text-xs">
                Date:{" "}
                {booking?.lr_date
                  ? new Date(booking.lr_date).toLocaleDateString("en-IN")
                  : new Date().toLocaleDateString("en-IN")}
              </div>
            </div>
          )}
        ...
        <div className="flex-1 text-center px-2">
          ...
          {customization.header_config.show_address && (
            <p className="text-xs mt-1">
              {customization.company_details?.address ||
                "Station Road, Transport Nagar, Delhi-110 042"}
            </p>
          )}
          <p className="text-xs">
            {customization.company_details?.phone || "+91-11-2345678"} |{" "}
            {customization.company_details?.email || "info@bharatlogistics.com"}
          </p>
      ...
      <div className="flex justify-between mb-2 text-xs bg-gray-50 p-2">
        <div>
          ...
          {booking?.service_type || "Surface Transport"}
        </div>
        <div>
          <span className="font-bold">Booking ID:</span>{" "}
          {booking?.booking_id || "BK2024001"}
        </div>
        <div>
        ...
        <div>
          <span className="font-bold">Bilti No:</span>{" "}
      ...
      <div className="grid grid-cols-2 gap-3 mb-2">
        <div className="border border-gray-400 p-2">
          ...
          {customization.visible_fields?.from_location !== false && (
            <div className="text-xs">
              {getLocationPart(booking?.from_location, "city") || "Delhi, NCR"}
            </div>
          )}
          {customization.visible_fields?.consignor !== false &&
            booking?.consignor && (
              <div className="mt-2">
                ...
                <div className="text-xs">
                  ...
                  <div>
                    GST: {booking.consignor.gst_number || "07AAAAA0000A1Z5"}
                  </div>
        ...
        <div className="border border-gray-400 p-2">
          ...
          {customization.visible_fields?.to_location !== false && (
            <div className="text-xs">
              {getLocationPart(booking?.to_location, "city") ||
                "Mumbai, Maharashtra"}
            </div>
          )}
          {customization.visible_fields?.consignee !== false &&
            booking?.consignee && (
              <div className="mt-2">
                ...
                <div className="text-xs">
                  ...
                  <div>
                    {booking.consignee.address || "456, Industrial Area"}
                  </div>
                  <div>
                    GST: {booking.consignee.gst_number || "27BBBBB1111B1Z5"}
                  </div>
  ...
  return (
    ...
    >
      ...
      <div className="border-b-2 border-black pb-2 mb-2">
        ...
        <div className="flex justify-between items-start mb-2">
          ...
          <div className="flex-1 text-center">
            ...
            {customization.header_config.show_address && (
              <div className="text-xs mt-1">
                {customization.company_details?.address ||
                  "45, Transport Hub, Indore - 452001"}
              </div>
            )}
          </div>
        ...
        <div className="bg-gray-100 px-2 py-1 flex justify-between text-xs">
          ...
          <div>
            {customization.header_config.show_gst && (
              <span>
                GSTIN: {customization.company_details?.gst || "23AAAAA0000A1Z5"}
              </span>
            )}
          ...
          <div>CIN: U63090MP2020PTC123456</div>
        </div>
      </div>
            ...
            <div className="p-2 text-xs">
              ...
              <div>
                {booking?.consignor?.address ||
                  "Shop No. 15, Electronic Market, Lamington Road"}
              </div>
              ...
              <div>
                ...
                {booking?.consignor?.phone || "9876543210"}
              </div>
              <div>
                <span className="font-semibold">Email:</span>{" "}
                {booking?.consignor?.email || "abc@electronics.com"}
              </div>
            </div>
          </div>
        )}
            ...
            <div className="p-2 text-xs">
              ...
              <div>
                {booking?.consignee?.address ||
                  "Plot No. 25, Industrial Area, Sector 18"}
              </div>
      ...
      <div className="bg-blue-50 border border-blue-300 p-2 mb-2">
        <div className="grid grid-cols-4 gap-2 text-xs">
          ...
          <div>
            ...
            {booking?.vehicle_number || "MH-12-AB-1234"}
          </div>
          <div>
          ...
          <div>
            ...
            {booking?.driver_name || "Ramesh Kumar"}
          </div>
          <div>
        ...
        <div className="border border-gray-400 p-2">
          ...
          <div className="text-xs space-y-1">
            ...
            <div className="flex justify-between border-t pt-1">
              ...
              <span>
                ₹{" "}
                {((booking?.freight_charges || 15000) + 1000).toLocaleString(
                  "en-IN"
                )}
              </span>
            </div>
            <div className="flex justify-between">
              ...
              <span>
                ₹{" "}
                {(((booking?.freight_charges || 15000) + 1000) * 0.025).toFixed(
                  2
                )}
              </span>
            </div>
            ...
            <div className="flex justify-between font-bold border-t pt-1">
              ...
              <span>
                ₹{" "}
                {(
                  ((booking?.freight_charges || 15000) + 1000) *
                  1.05
      ...
      <div className="text-center text-xs text-gray-600 mt-3 border-t pt-2">
        <div>
          This is a system generated document valid for 3 days from the date of
          generation
        </div>
        <div>
          For tracking visit: www.nationalcargo.com | Customer Care:
          1800-123-4567
        </div>
      </div>
    </div>
    ...
    >
      ...
      <div className="flex justify-between items-start mb-3 pb-2 border-b-2 border-gray-700">
        ...
        <div className="flex-1 text-center">
          ...
          <div className="text-sm font-semibold bg-gray-100 px-3 py-1 rounded">
            TAX INVOICE / LORRY RECEIPT
          </div>
          {customization.header_config.show_address && (
            <p className="text-xs mt-1">
              {customization.company_details?.address ||
                "B-45, Logistics Complex, Noida - 201301"}
            </p>
          )}
          <p className="text-xs">
            Ph: {customization.company_details?.phone || "0120-4567890"} |
            Email:{" "}
            {customization.company_details?.email || "info@rapidcargo.com"}
          </p>
          {customization.header_config.show_gst && (
      ...
      <div className="grid grid-cols-5 gap-2 mb-3 text-xs bg-blue-50 p-2 rounded">
        <div>
          ...
          {booking?.lr_number || "LR2024001234"}
        </div>
        <div>
        ...
        <div>
          <span className="font-bold">E-Way:</span>{" "}
        ...
        {customization.visible_fields?.consignee !== false && (
          <div className="border-2 border-green-300 rounded">
            ...
            <div className="p-2 text-xs">
              ...
              <div className="mt-1">
                {booking?.consignee?.address || "Plot No. 25, Industrial Area"}
              </div>
      ...
      <div className="bg-yellow-50 border border-yellow-400 p-2 mb-3 rounded">
        <div className="grid grid-cols-4 gap-3 text-xs">
          ...
          <div>
            <span className="font-bold">Driver:</span>{" "}
            {booking?.driver_name || "Suresh Kumar"}
          </div>
          <div>
            <span className="font-bold">Mobile:</span>{" "}
      ...
      <div className="border border-gray-400 mb-3">
        ...
        <div className="p-1">
          {cargoData.map((row, index) => (
            <div
              key={index}
              className="grid grid-cols-12 text-xs py-1 border-b border-gray-200 last:border-b-0"
            >
      ...
      <div className="grid grid-cols-2 gap-3 mb-3">
        ...
        <div className="border border-gray-300 p-2">
          ...
          <div className="text-xs space-y-1">
            ...
            <div>
              <span className="font-semibold">Delivery Type:</span> Door to Door
            </div>
            <div>
              <span className="font-semibold">Insurance:</span> Transit
              Insurance
            </div>
            <div>
              <span className="font-semibold">Remarks:</span> Handle with Care
            </div>
          </div>
        </div>
        ...
        <div className="border border-gray-300 p-2">
          ...
          <div className="text-xs space-y-1">
            <div className="flex justify-between">
              ...
              <span>
                ₹ {(booking?.freight_charges || 18500).toLocaleString("en-IN")}
                .00
              </span>
            </div>
            <div className="flex justify-between">
              <span>CGST @ 2.5%:</span>
              <span>
                ₹ {((booking?.freight_charges || 18500) * 0.025).toFixed(2)}
              </span>
            </div>
            <div className="flex justify-between">
              <span>SGST @ 2.5%:</span>
            ...
            <div className="border-t-2 border-gray-400 pt-1 mt-2">
              <div className="flex justify-between font-bold text-sm">
                ...
                <span>
                  ₹{" "}
                  {((booking?.freight_charges || 18500) * 1.05).toLocaleString(
                    "en-IN",
      ...
      <div className="border border-gray-400 p-2 mb-3">
        ...
        <div className="text-xs">
          <div className="mb-1">
            ...
            this invoice shows the actual price of goods/services and all
      ...
      <div className="text-center text-xs text-gray-600 mt-3 border-t pt-2">
        <div>
          ...
          {customization.company_details?.city || "Noida"} Courts
        </div>
        <div>
          For any queries contact:{" "}
          {customization.company_details?.phone || "0120-4567890"} | Track:
          www.rapidcargo.com
        </div>
      </div>
    </div>
...
export const LRTemplateOnboarding = ({ onComplete, changeMode = false }) => {
  ...
  const loadInitialData = async () => {
    try {
      ...
      if (changeMode) {
        const { hasTemplate, template, company } =
          await getCurrentTemplateWithCompany();
        ...
        if (hasTemplate && template && company) {
          ...
          const currentTemplateCode = template.custom_fields?.find(
            (f) => f.key === "base_template_code"
          )?.value;
          const currentTemplate = templateList.find(
            (t) => t.code === currentTemplateCode
          );
          if (currentTemplate) {
                    ...
                    {Object.entries({
                      ...
                      <label key={key} className="flex items-center space-x-2">
                        <input
                          type="checkbox"
                          checked={
                            customization.visible_fields?.[key] !== false
                          }
                          onChange={(e) =>
                            handleCustomizationChange(
                              "visible_fields",
                  ...
                  {customization.footer_config.show_signature && (
                    <div>
                      ...
                      <div className="grid grid-cols-3 gap-2">
                        {customization.footer_config.signature_labels.map(
                          (label, index) => (
                            <Input
                              key={index}
                              value={label}
                              onChange={(e) =>
                                handleSignatureLabelsChange(
                                  index,
                                  e.target.value
                                )
                              }
            ...
            {step === 3 && (
              <Card className="w-full">
                <CardHeader>
                  ...
                  <p className="text-muted-foreground">
                    This is exactly how your LR will look when generated with
                    your customizations
                  </p>
                </CardHeader>
                <CardContent>
