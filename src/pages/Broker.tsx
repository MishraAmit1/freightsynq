...
const ImportBrokersModal: React.FC<{
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl min-[2000px]:max-w-5xl max-h-[90vh] bg-card border border-border dark:border-border">
        <DialogHeader className="border-b border-border dark:border-border pb-4 min-[2000px]:pb-5">
          <DialogTitle className="text-xl min-[2000px]:text-2xl flex items-center gap-2 text-foreground dark:text-white">
            <div className="p-2 min-[2000px]:p-2.5 bg-accent dark:bg-primary/10 rounded-lg">
          ...
          <div className="space-y-4 min-[2000px]:space-y-5">
            <div className="flex justify-between items-center">
              ...
              <Button
                ...
                className="min-[2000px]:h-10 min-[2000px]:px-4 min-[2000px]:text-base border-border dark:border-border hover:bg-accent dark:hover:bg-secondary text-foreground dark:text-white transition-all"
              >
            ...
            <div
              {...getRootProps()}
              className={cn(
                "border-2 border-dashed rounded-xl p-8 min-[2000px]:p-10 text-center cursor-pointer transition-all duration-200",
                isDragActive
            ...
            >
              <input {...getInputProps()} />
              <FileUp className="w-12 h-12 min-[2000px]:w-14 min-[2000px]:h-14 mx-auto mb-4 text-muted-foreground dark:text-muted-foreground" />
              {file ? (
                <div>
            ...
            <div className="bg-accent dark:bg-primary/10 p-4 min-[2000px]:p-5 rounded-lg border border-primary/20">
              <h4 className="font-medium mb-2 min-[2000px]:text-lg flex items-center gap-2 text-foreground dark:text-white">
                <AlertCircle className="w-4 h-4 min-[2000px]:w-5 min-[2000px]:h-5 text-primary" />
                Required Fields:
              </h4>
              <ul className="text-sm min-[2000px]:text-base text-muted-foreground dark:text-muted-foreground space-y-1 list-disc list-inside ml-6">
                <li>
                ...
                <li>
                  <span className="font-medium">phone</span> (optional) - Phone
                  number (minimum 10 digits if provided)
                </li>
                <li>
        ...
        {step === "preview" && preview && (
          <div className="space-y-4 min-[2000px]:space-y-5">
            <div className="grid grid-cols-3 gap-4 min-[2000px]:gap-5">
              <Card className="border-green-200 bg-gradient-to-br from-green-50/50 to-transparent dark:from-green-900/10 dark:border-green-800/30">
                <CardContent className="pt-6 min-[2000px]:pt-7">
                  <div className="flex items-center gap-3">
                    <div className="p-2 min-[2000px]:p-2.5 bg-green-100 dark:bg-green-900/30 rounded-lg">
                      <CheckCircle className="w-5 h-5 min-[2000px]:w-6 min-[2000px]:h-6 text-green-600 dark:text-green-400" />
                    </div>
                    <div>
                      <p className="text-2xl min-[2000px]:text-3xl font-bold text-green-600 dark:text-green-400">
              ...
              <Card className="border-red-200 bg-gradient-to-br from-red-50/50 to-transparent dark:from-red-900/10 dark:border-red-800/30">
                <CardContent className="pt-6 min-[2000px]:pt-7">
                  <div className="flex items-center gap-3">
                    <div className="p-2 min-[2000px]:p-2.5 bg-red-100 dark:bg-red-900/30 rounded-lg">
                      <XCircle className="w-5 h-5 min-[2000px]:w-6 min-[2000px]:h-6 text-red-600 dark:text-red-400" />
                    </div>
                    <div>
                      <p className="text-2xl min-[2000px]:text-3xl font-bold text-red-600 dark:text-red-400">
              ...
              <Card className="border-yellow-200 bg-gradient-to-br from-yellow-50/50 to-transparent dark:from-yellow-900/10 dark:border-yellow-800/30">
                <CardContent className="pt-6 min-[2000px]:pt-7">
                  <div className="flex items-center gap-3">
                    <div className="p-2 min-[2000px]:p-2.5 bg-yellow-100 dark:bg-yellow-900/30 rounded-lg">
                      <AlertCircle className="w-5 h-5 min-[2000px]:w-6 min-[2000px]:h-6 text-yellow-600 dark:text-yellow-400" />
                    </div>
                    <div>
                      <p className="text-2xl min-[2000px]:text-3xl font-bold text-yellow-600 dark:text-yellow-400">
            ...
            <Tabs defaultValue="valid" className="w-full">
              <TabsList className="grid w-full grid-cols-3 bg-muted min-[2000px]:h-11">
                <TabsTrigger
                  value="valid"
                  className="min-[2000px]:text-base data-[state=active]:bg-green-100 data-[state=active]:text-green-700 dark:data-[state=active]:bg-green-900/30 dark:data-[state=active]:text-green-400"
                >
                  Valid ({preview.valid.length})
                </TabsTrigger>
                <TabsTrigger
                  value="invalid"
                  className="min-[2000px]:text-base data-[state=active]:bg-red-100 data-[state=active]:text-red-700 dark:data-[state=active]:bg-red-900/30 dark:data-[state=active]:text-red-400"
                >
                  Invalid ({preview.invalid.length})
                </TabsTrigger>
                <TabsTrigger
                  value="duplicates"
                  className="min-[2000px]:text-base data-[state=active]:bg-yellow-100 data-[state=active]:text-yellow-700 dark:data-[state=active]:bg-yellow-900/30 dark:data-[state=active]:text-yellow-400"
                >
              ...
              <TabsContent value="valid">
                <ScrollArea className="h-[300px] min-[2000px]:h-[350px] w-full rounded-lg border border-border dark:border-border">
                  <Table>
                    <TableHeader>
              ...
              <TabsContent value="invalid">
                <ScrollArea className="h-[300px] min-[2000px]:h-[350px] w-full">
                  <div className="space-y-2 p-2">
                    {preview.invalid.map((item, index) => (
                      <Card
                        key={index}
                        className="border-red-200 dark:border-red-800/30 bg-red-50/50 dark:bg-red-900/10"
                      >
                          ...
                          <div className="flex justify-between items-start">
                            <div>
                              ...
                              {item.errors.map((error, i) => (
                                <p
                                  key={i}
                                  className="text-sm min-[2000px]:text-base text-red-600 dark:text-red-400 mt-1"
                                >
        ...
        {step === "importing" && (
          <div className="space-y-4 min-[2000px]:space-y-5 py-8 min-[2000px]:py-10">
            <div className="text-center">
              {progress.status === "completed" ? (
                <div className="relative">
                  <CheckCircle className="w-16 h-16 min-[2000px]:w-20 min-[2000px]:h-20 mx-auto mb-4 text-green-500" />
                ...
                <div className="relative">
                  <Loader2 className="w-16 h-16 min-[2000px]:w-20 min-[2000px]:h-20 mx-auto mb-4 animate-spin text-primary" />
        ...
        <DialogFooter className="border-t border-border dark:border-border pt-4 min-[2000px]:pt-5">
          {step === "preview" && (
            <>
              <Button
                variant="outline"
                onClick={() => setStep("upload")}
                className="min-[2000px]:h-11 min-[2000px]:px-6 min-[2000px]:text-base border-border dark:border-border hover:bg-muted dark:hover:bg-secondary"
              >
                Back
              </Button>
              <Button
                ...
                className="min-[2000px]:h-11 min-[2000px]:px-6 min-[2000px]:text-base bg-primary hover:bg-primary-hover active:bg-primary-active text-primary-foreground font-medium shadow-sm hover:shadow-md transition-all"
              >
  ...
  return (
    <div className="space-y-6 min-[2000px]:space-y-8">
      ...
      <div className="flex flex-col lg:flex-row gap-4 min-[2000px]:gap-6 lg:items-center lg:justify-between">
        <div className="bg-card border border-border dark:border-border rounded-xl flex-1 p-4 sm:p-5 min-[2000px]:p-6 shadow-sm">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 sm:gap-0 h-full">
            <div className="sm:px-6 min-[2000px]:sm:px-8 py-4 first:pl-0 relative">
              ...
              <div className="relative z-10">
                <p className="text-xs sm:text-sm min-[2000px]:text-base text-muted-foreground dark:text-muted-foreground">
                  Total Brokers
                </p>
                <p className="text-2xl sm:text-3xl min-[2000px]:text-4xl font-bold text-foreground dark:text-white">
                  {stats.total}
                </p>
              </div>
            ...
            <div className="sm:px-6 min-[2000px]:sm:px-8 py-4 relative">
              <div className="absolute top-1 right-2 opacity-10">
                <UserCheck className="w-8 h-8 min-[2000px]:w-10 min-[2000px]:h-10 text-muted-foreground dark:text-muted-foreground" />
              </div>
              <div className="relative z-10">
                <p className="text-xs sm:text-sm min-[2000px]:text-base text-muted-foreground dark:text-muted-foreground">
                  Active
            ...
            <div className="sm:px-6 min-[2000px]:sm:px-8 py-4 relative">
              <div className="absolute top-1 right-2 opacity-10">
                <Shield className="w-8 h-8 min-[2000px]:w-10 min-[2000px]:h-10 text-muted-foreground dark:text-muted-foreground" />
              </div>
              <div className="relative z-10">
                <p className="text-xs sm:text-sm min-[2000px]:text-base text-muted-foreground dark:text-muted-foreground">
                  Inactive
            ...
            <div className="sm:px-6 min-[2000px]:sm:px-8 py-4 last:pr-0 relative">
              <div className="absolute top-1 right-2 opacity-10">
                <Mail className="w-8 h-8 min-[2000px]:w-10 min-[2000px]:h-10 text-muted-foreground dark:text-muted-foreground" />
              </div>
              <div className="relative z-10">
                <p className="text-xs sm:text-sm min-[2000px]:text-base text-muted-foreground dark:text-muted-foreground">
                  With Email
        ...
        <div className="flex flex-col gap-2 min-[2000px]:gap-3 md:flex-shrink-0 md:min-w-[200px] min-[2000px]:md:min-w-[240px]">
          <Button
            size="sm"
            onClick={() => {
              setEditingBroker(null);
            ...
            className="w-full min-[2000px]:h-11 min-[2000px]:text-base bg-primary hover:bg-primary-hover active:bg-primary-active text-primary-foreground font-medium shadow-sm hover:shadow-md transition-all"
          >
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    ...
                    className="flex-1 min-[2000px]:h-10 min-[2000px]:text-base bg-card border-border dark:border-border hover:bg-accent dark:hover:bg-secondary text-foreground dark:text-white"
                  >
      ...
      <div className="bg-card border border-border dark:border-border rounded-xl shadow-sm overflow-hidden">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div className="relative w-full sm:w-96 min-[2000px]:sm:w-[450px]">
              ...
              <Input
                ...
                className="pl-10 min-[2000px]:pl-12 pr-10 min-[2000px]:pr-12 h-10 min-[2000px]:h-12 min-[2000px]:text-base border-border dark:border-border bg-card focus:ring-2 focus:ring-ring focus:border-primary text-foreground dark:text-white placeholder:text-muted-foreground dark:placeholder:text-muted-foreground"
              />
              {searchTerm && (
                <Button
                  variant="ghost"
                  size="sm"
                  className="absolute right-1 top-1/2 -translate-y-1/2 h-7 w-7 min-[2000px]:h-8 min-[2000px]:w-8 p-0 hover:bg-accent dark:hover:bg-secondary"
                  onClick={() => setSearchTerm("")}
                >
                  <X className="h-3 w-3 min-[2000px]:h-4 min-[2000px]:w-4" />
                </Button>
              )}
            </div>
          </div>
        ...
        <div className="p-4 sm:p-6 min-[2000px]:p-8">
            ...
            <Table className="broker-table">
              <TableHeader>
                <TableRow className="hover:bg-muted dark:hover:bg-[#252530] border-b border-border dark:border-border">
                  ...
                  <TableHead className="font-semibold text-muted-foreground dark:text-muted-foreground min-[2000px]:text-base">
                    <div className="flex items-center gap-2">
                      <Mail className="w-4 h-4 min-[2000px]:w-5 min-[2000px]:h-5" />
                      Email
                    </div>
                  </TableHead>
                  <TableHead className="font-semibold text-muted-foreground dark:text-muted-foreground min-[2000px]:text-base">
                  ...
                  <TableHead className="font-semibold text-center text-muted-foreground dark:text-muted-foreground min-[2000px]:text-base">
                    Actions
                  </TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {filteredBrokers.length === 0 ? (
                    ...
                    >
                      <div className="flex flex-col items-center gap-4">
                        <div className="p-4 min-[2000px]:p-5 bg-muted rounded-full">
                          <Building2 className="w-12 h-12 min-[2000px]:w-14 min-[2000px]:h-14 text-muted-foreground dark:text-muted-foreground" />
                        </div>
                  ...
                  filteredBrokers.map((broker) => (
                    ...
                    >
                      <TableCell>
                        <div className="font-semibold flex items-center gap-2 text-foreground dark:text-white min-[2000px]:text-base">
                          <Building className="w-4 h-4 min-[2000px]:w-5 min-[2000px]:h-5 text-muted-foreground dark:text-muted-foreground" />
                          {broker.name}
                        </div>
                      </TableCell>
                      <TableCell>
                        <div className="flex items-center gap-2 text-sm min-[2000px]:text-base text-foreground dark:text-white">
                          <User className="w-3.5 h-3.5 min-[2000px]:w-4 min-[2000px]:h-4 text-muted-foreground dark:text-muted-foreground" />
                      ...
                      <TableCell>
                        {broker.phone ? (
                          ...
                          <span className="text-muted-foreground dark:text-muted-foreground text-sm min-[2000px]:text-base">
                            No phone
                          </span>
                        )}
                      </TableCell>
                      <TableCell>
                        {broker.city ? (
                          <div className="flex items-center gap-2 text-sm min-[2000px]:text-base text-foreground dark:text-white">
                            <MapPin className="w-3.5 h-3.5 min-[2000px]:w-4 min-[2000px]:h-4 text-muted-foreground dark:text-muted-foreground" />
                            <span>{broker.city}</span>
                          </div>
                        ) : (
                          <span className="text-muted-foreground dark:text-muted-foreground min-[2000px]:text-base">
                            -
                          </span>
                        )}
                      </TableCell>
                      <TableCell>
                        {broker.email ? (
                          <div className="flex items-center gap-2 text-xs min-[2000px]:text-sm text-muted-foreground dark:text-muted-foreground">
                            <Mail className="w-3 h-3 min-[2000px]:w-3.5 min-[2000px]:h-3.5" />
                            <span className="truncate max-w-[150px] min-[2000px]:max-w-[180px]">
                              {broker.email}
                            </span>
                          </div>
                        ) : (
                          ...
                          <DropdownMenu>
                            ...
                            >
                              <DropdownMenuItem
                                ...
                                className="min-[2000px]:text-base hover:bg-accent dark:hover:bg-secondary"
                              >
                              ...
                              <DropdownMenuItem
                                className="text-red-600 min-[2000px]:text-base hover:bg-red-50 dark:hover:bg-red-900/20"
          ...
          {/* Mobile Card View - No changes needed for mobile */}
        ...
        <AlertDialogContent className="max-w-md min-[2000px]:max-w-lg bg-card border-border dark:border-border">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-left text-muted-foreground dark:text-muted-foreground min-[2000px]:text-base">
              ...
              broker.
              <div className="mt-3 p-3 min-[2000px]:p-4 bg-red-50 dark:bg-red-900/10 rounded-lg border border-red-200 dark:border-red-800/30">
                <p className="text-sm min-[2000px]:text-base font-medium text-red-600 dark:text-red-400">
                  ⚠️ Warning:
                </p>
                <p className="text-xs min-[2000px]:text-sm mt-1 text-red-600 dark:text-red-400">
          ...
          <AlertDialogFooter>
            <AlertDialogCancel className="min-[2000px]:h-11 min-[2000px]:px-6 min-[2000px]:text-base border-border dark:border-border hover:bg-muted dark:hover:bg-secondary">
              Cancel
            </AlertDialogCancel>
            <AlertDialogAction
              onClick={handleDeleteBroker}
              className="min-[2000px]:h-11 min-[2000px]:px-6 min-[2000px]:text-base bg-red-600 text-white hover:bg-red-700 dark:bg-red-600 dark:hover:bg-red-700"
            >
              Delete Broker
            </AlertDialogAction>
          </AlertDialogFooter>
