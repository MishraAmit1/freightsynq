                    ...
                    <TableBody>
                      {preview.valid.map((row, index) => (
                        <TableRow key={index} className="hover:bg-muted/30">
                          ...
                          <TableCell>
                            <Badge variant="outline">{row.party_type}</Badge>
                          </TableCell>
                        </TableRow>
                      ))}
                    </TableBody>
...
export const Customers = () => {
  ...
  // ✅ Load parties function - FIXED
  const loadParties = useCallback(async () => {
    setIsLoading(true); // ← Yahan set karo
    ...
    try {
      ...
      setIsLoading(false); // ← Name change
    }
  }, [toast]);
  ...
  const handleDrawerSuccess = () => {
    handleDrawerClose(); // ← Pehle drawer band karo
    loadParties(); // ← Direct call - no state set before
  };
  ...
  // ✅ UPDATED - Removed Last Booking & Contact Person
  // ✅ UPDATED - Removed only Last Booking & Contact Person
  const handleExport = () => {
    const exportData = filteredParties.map((party) => ({
      ...
      "Trips This Month": party.trips_this_month || 0, // ✅ Added back
    }));

    // ✅ Using Papa Parse for proper CSV generation
          ...
          <Table className="customers-table">
            <TableHeader>
              <TableRow className="border-b border-border dark:border-border hover:bg-muted dark:hover:bg-[#252530]">
                ...
                <TableHead className="w-[12%] font-semibold text-muted-foreground dark:text-muted-foreground">
                  Type
                </TableHead>
                <TableHead className="w-[15%] font-semibold text-muted-foreground dark:text-muted-foreground">
                  City / State
                </TableHead>
                <TableHead className="w-[10%] font-semibold text-muted-foreground dark:text-muted-foreground">
                  Last Booking
                </TableHead>
                <TableHead className="w-[8%] font-semibold text-muted-foreground dark:text-muted-foreground">
                  Trips
                </TableHead>
                <TableHead className="w-[10%] font-semibold text-muted-foreground dark:text-muted-foreground">
                  Verified
                ...
                <TableHead className="w-[5%] font-semibold text-muted-foreground dark:text-muted-foreground text-center pr-6">
                  Actions
                </TableHead>
              </TableRow>
            </TableHeader>
