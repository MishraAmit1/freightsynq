...
const getSuperAdminEmails = (): string[] => {
    ...
    return emails.split(',').map((email: string) => email.trim().toLowerCase()).filter(Boolean);
};
export const Login = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (data?.user) {
                ...
                const isSuperAdminEmail = superAdmins.includes(emailToUse.toLowerCase());
                if (isSuperAdminEmail) {
                    toast.success('Welcome back, Super Admin!');
                    // No further checks needed for Super Admin
                    return;
                }
    ...
    return (
        <div className="min-h-screen w-full flex">
            {/* ========================================
                LEFT PANEL - LOGIN FORM (WHITE/LIGHT)
                ======================================== */}
            <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-8 bg-white dark:bg-[#1E1E24]">
                <div className="w-full max-w-md">
                    {/* Header */}
                    <div className="mb-8">
                        <p className="text-sm font-medium text-primary dark:text-[#FCC52C] mb-2">Welcome back</p>
                        ...
                        <CardContent className="p-6">
                            <form onSubmit={handleSubmit} className="space-y-5">
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="identifier" className="text-sm font-medium text-[#0A0A0A] dark:text-white">
                                        Username or Email
                                    </Label>
                                ...
                                <div className="space-y-2">
                                    <div className="flex items-center justify-between">
                                        <Label htmlFor="password" className="text-sm font-medium text-[#0A0A0A] dark:text-white">
                                            Password
                                        </Label>
                                        <Link
                                            to="/forgot-password"
